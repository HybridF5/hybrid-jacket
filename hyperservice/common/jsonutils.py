...
from hyperservice.common import gettextutils
from hyperservice.common import importutils
from hyperservice.common import strutils
...
def to_primitive(value, convert_instances=False, convert_datetime=True,
    ...
    # full tests on hyperservice project, resulting in the following counts:
