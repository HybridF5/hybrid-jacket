...
wsgi_opts = [
    cfg.StrOpt('api_paste_config',
               default="hyperservice-paste.ini",
               help='File name for the paste.deploy config for hyperservice-api'),
...
class Server(object):
    ...
    def __init__(self, name, app, host='0.0.0.0', port=0, pool_size=None,
        ...
        :returns: None
        :raises: hyperservice.exception.InvalidInput
        """
        ...
        self._logger = logging.getLogger("hyperservice.%s.wsgi.server" % self.name)
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'hyperservice.best_content_type' not in self.environ:
            ...
            self.environ['hyperservice.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['hyperservice.best_content_type']
...
class BaseApplication(object):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            [app:wadl]
            latest_version = 1.3
            paste.app_factory = hyperservice.api.fancy_api:Wadl.factory

        which would result in a call to the `Wadl` class as

            import hyperservice.api.fancy_api
...
class Middleware(BaseApplication):
    ...
    def factory(cls, global_config, **local_config):
        ...
        A hypothetical configuration would look like:
            ...
            paste.filter_factory = hyperservice.api.analytics:Analytics.factory

        which would result in a call to the `Analytics` class as

            import hyperservice.api.analytics
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `hyperservice.exception.PasteAppNotFound`
...
PARAMS_ENV = 'hyperservice.params'
